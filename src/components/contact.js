...
export default class Contact extends Component {
  ...
  render(){
    ...
    return(
        ...
        <h3 className='white-color'>Võta ühendust</h3>
            <hr className='white-color sub'/>
            <p className='text-faded contact'>Saada küsimus emaili teel või allpool olevate sotsiaalmeedia linkide kaudu</p>
            <div className="row">
        ...
        <form className="col s12" onSubmit={this.sendData}>
          <div className="row">
              <div className="input-field col s12 m6">
                ...
                <input id="icon_prefix" type="text" className="validate" placeholder="Nimi" name="name" value={name} onChange={e => this.setState({name: e.target.value})}/>
              </div>
              <div className="input-field col s12 m6">
            ...
            <div className="row">
              <div className="input-field col s12"> 
                ...
                <input id="icon_prefix2" className="validate" type="text" placeholder="Pealkiri" name="subject" value={subject} onChange={e => this.setState({subject: e.target.value})}/>
              </div>
            </div>
            <div className="row">
            <div className="input-field col s12">
              <textarea id="textArea1" className="materialize-textarea validate" type="text" placeholder="Sõnum" value={message} name="message" onChange={e => this.setState({message: e.target.value})}/>
            </div>
          </div>
        <button className="btn waves-effect waves-light" type="submit" name="action">Saada kiri<i className="material-icons right">send</i>
        </button>
        {submitResult}
          </form>
            </div>       
