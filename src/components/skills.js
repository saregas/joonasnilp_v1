        ...
        <section id='skills'>
            ...
            <div className="container">
                ...
                <div className="col s12 l6 skills">
                    ...
                    <div className="col s6 skillsText"><strong>Fotoaparaat</strong> Nikon</div>

                </div>
                
                <div className="col s12 l6 skills">

                <div className="col s6 push-l6 skillsText"><strong>Objektiivid</strong> tele, makro jne.</div>  
                ...
                <div className="col s12 l6 skills">
                    ...
                    <div className="col s6 skillsText"><strong>Droon</strong> DJI Phantom 4</div>

                </div>
                
                <div className="col s12 l6 skills">

                <div className="col s6 push-l6 skillsText"><strong>Kaamerad</strong> GoPro Hero 4 jne.</div>  
